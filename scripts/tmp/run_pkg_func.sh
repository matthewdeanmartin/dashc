...
def _inflate() -> bytes:
    b64 = """"""
...
def _main():
    ...
    try:
        module = importlib.import_module("mypkg.cli")
        func = getattr(module, "main")
    except (ImportError, AttributeError) as e:
        print(f"Error: Could not find entrypoint \"main\" in \"mypkg.cli\".", file=sys.stderr)
